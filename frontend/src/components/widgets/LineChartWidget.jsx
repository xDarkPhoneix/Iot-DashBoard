...
import { getChartOptions, getLineChartData } from '../../utils/chartConfig';

const LineChartWidget = ({ deviceId, dark }) => {
  ...
  const chartData = getLineChartData(history, metricName, unit, dark);
