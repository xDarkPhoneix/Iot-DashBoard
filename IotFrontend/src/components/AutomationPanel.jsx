      ...
      <div className="grid gap-6">
        {automationRules.map((rule) => (
          ...
          >
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-4">
              <div>
                <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-2">Trigger Condition</h4>
              ...
              <div>
                <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-2">Actions ({rule.actions.length})</h4>
        ...
        {automationRules.length === 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No Automation Rules</h3>
