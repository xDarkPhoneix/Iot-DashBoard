...
export const DashboardProvider = ({ children }) => {
  ...
  useEffect(() => {
    const fetchSensorData = async () => {
      try {
        const response = await axios.get("/api/v1/sensor/data", {
  ...
  useEffect(() => {
    ...
    const fetchWidgets = async () => {
      try {
        const response = await axios.get("/api/v1/dashboard/widgets", {
          withCredentials: true,
        });
        console.log("ssopx",response);
    ...
    const fetchDevices = async () => {
      try {
        const response = await axios.post("/api/v1/devices/get", {
          withCredentials: true,
        });
    ...
    const fetchDevicesbyID = async (ownerID) => {
      const res = await axios.post(
        "/api/v1/devices/deviceById",
        { ownerID: ownerID },
        { withCredentials: true }
      );
      console.log("user ev",res.data);
      setDevices(res.data);
      //console.log("lllllllll",devices);
